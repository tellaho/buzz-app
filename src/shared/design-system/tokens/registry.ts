...
export const ROLE_GROUPS: RoleGroup[] = [
  ...
  },
  {
    ...
    roles: [
      {
        token: "bg-category-core",
        variable: "--category-core",
        pointsAt: "purple-4 light / purple-3 dark",
        use: "Core instruction traits.",
        status: "proposed",
        owner: "Taylor",
      },
      {
        token: "bg-category-capabilities",
        variable: "--category-capabilities",
        pointsAt: "blue-4 light / blue-3 dark",
        use: "Capability instruction traits.",
        status: "proposed",
        owner: "Taylor",
      },
      {
        token: "bg-category-communication",
        variable: "--category-communication",
        pointsAt: "green-4 light / green-3 dark",
        use: "Communication instruction traits.",
        status: "proposed",
        owner: "Taylor",
      },
      {
        token: "bg-category-practice",
        variable: "--category-practice",
        pointsAt: "orange-4 light / orange-3 dark",
        use: "Practice instruction traits.",
        status: "proposed",
        owner: "Taylor",
      },
      {
        token: "bg-category-custom",
        variable: "--category-custom",
        pointsAt: "amber-4 light / amber-3 dark",
        use: "Profile-local custom instruction traits.",
        status: "proposed",
        owner: "Taylor",
      },
      {
        token: "bg-category-plugin",
        variable: "--category-plugin",
        pointsAt: "cyan-4 light / cyan-3 dark",
        use: "Unclassified plugin instruction traits.",
        status: "proposed",
        owner: "Taylor",
      },
    ],
